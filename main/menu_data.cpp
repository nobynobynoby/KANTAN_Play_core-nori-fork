...
static constexpr menu_item_ptr menu_system[] = {
  ...
  (const mi_tree_t          []){{ def::menu_category_t::menu_system,204,   3  , { "USB"            , nullptr}}},
  (const mi_usb_power_t     []){{ def::menu_category_t::menu_system,205,    4 , { "Host Power Supply", "ホスト給電設定" }}},
  (const mi_usb_midi_t      []){{ def::menu_category_t::menu_system,206,   3  , { "USB MIDI"       , nullptr     }}},
  ...
  (const mi_vol_uart_t      []){{ def::menu_category_t::menu_system,220,   3  , { "UART Mastervol" , "UARTマスター音量"}}},
  (const mi_vol_adcmic_t    []){{ def::menu_category_t::menu_system,221,   3  , { "ADC MicAmp"     , "ADCマイクアンプ" }}},
  (const mi_tree_t          []){{ def::menu_category_t::menu_system,222,  2   , { "Output Dest"    , "出力先"        }}},
  (const mi_channel_dest_t  []){{ def::menu_category_t::menu_system,223,   3  , { "Channel 1" , "チャンネル1" }, 1 - 1}},
  (const mi_channel_dest_t  []){{ def::menu_category_t::menu_system,224,   3  , { "Channel 2" , "チャンネル2" }, 2 - 1}},
  (const mi_channel_dest_t  []){{ def::menu_category_t::menu_system,225,   3  , { "Channel 3" , "チャンネル3" }, 3 - 1}},
  (const mi_channel_dest_t  []){{ def::menu_category_t::menu_system,226,   3  , { "Channel 4" , "チャンネル4" }, 4 - 1}},
  (const mi_channel_dest_t  []){{ def::menu_category_t::menu_system,227,   3  , { "Channel 5" , "チャンネル5" }, 5 - 1}},
  (const mi_channel_dest_t  []){{ def::menu_category_t::menu_system,228,   3  , { "Channel 6" , "チャンネル6" }, 6 - 1}},
  (const mi_channel_dest_t  []){{ def::menu_category_t::menu_system,229,   3  , { "Channel 7" , "チャンネル7" }, 7 - 1}},
  (const mi_channel_dest_t  []){{ def::menu_category_t::menu_system,230,   3  , { "Channel 8" , "チャンネル8" }, 8 - 1}},
  (const mi_channel_dest_t  []){{ def::menu_category_t::menu_system,231,   3  , { "Channel 9" , "チャンネル9" }, 9 - 1}},
  (const mi_channel_dest_t  []){{ def::menu_category_t::menu_system,232,   3  , { "Channel 10" , "チャンネル10" }, 10 - 1}},
  (const mi_channel_dest_t  []){{ def::menu_category_t::menu_system,233,   3  , { "Channel 11" , "チャンネル11" }, 11 - 1}},
  (const mi_channel_dest_t  []){{ def::menu_category_t::menu_system,234,   3  , { "Channel 12" , "チャンネル12" }, 12 - 1}},
  (const mi_channel_dest_t  []){{ def::menu_category_t::menu_system,235,   3  , { "Channel 13" , "チャンネル13" }, 13 - 1}},
  (const mi_channel_dest_t  []){{ def::menu_category_t::menu_system,236,   3  , { "Channel 14" , "チャンネル14" }, 14 - 1}},
  (const mi_channel_dest_t  []){{ def::menu_category_t::menu_system,237,   3  , { "Channel 15" , "チャンネル15" }, 15 - 1}},
  (const mi_channel_dest_t  []){{ def::menu_category_t::menu_system,238,   3  , { "Channel 16" , "チャンネル16" }, 16 - 1}},
  (const mi_all_reset_t     []){{ def::menu_category_t::menu_system,239,  2   , { "Reset All Settings", "全設定リセット"    }}},
  (const mi_manual_qr_t     []){{ def::menu_category_t::menu_system,240, 1    , { "Manual QR"      , "説明書QR"     }}},
  nullptr, // end of menu
};
